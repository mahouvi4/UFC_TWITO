        ...
        <div class="row">
            ...
            <div class="card">
                <div><img src="{{asset('logou/log4.png')}}"></div>
                       ...
                       <p class="p1"><h2 style="color:beige;font-family:Broadway;text-align:center">Sign-Up UFC</h2></p>
             

                 <form method="POST" id="stx">
                      

                             <div class="row">
                             <div class="col-6">
                                  <div class="group-control">
                                      <input type="text" class="form-control il1 mt-2" name="name_ufc" placeholder=" name ufc">
                                  </div>
                              ...
                              <div class="col-6">
                                  <div class="group-control">
                                      <input type="email" class="form-control il1 mt-2" name="email_ufc" placeholder="email ufc">
                                  </div>
                              ...
                              <div class="col-12">
                                  <div class="group-control">
                                      <textarea class="form-control il1 mt-2" name="biblio_ufc" height="5px" placeholder="biobliography ufc"></textarea>
                                  </div>
                              ...
                              <div class="group-control">
                                     <button type="button" class="btn btn-primary " style="border:none;border-radius:20px;width:100%;background-color:#79C2F2" onclick="add_ufc()">Sign-Up</button>
                              </div>
