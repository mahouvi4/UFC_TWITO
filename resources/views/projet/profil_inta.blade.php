                                ...
                                <div class="container">
                                    <div class="row" style="padding-top: 20px;">
                                        <div class="col-3">
                                            ...
                                            <img class="img-profile" src="{{asset('prof/'.$prof_inta->photo)}}" style="width:100px;height:100px;border-radius:60px;margin-left:-3px">
                                            
                                        </div>

                                        <div class="col-9">
                                            <button type="button" class="btn btn-outline-secondary button-edit" style="margin-left:58px;margin-top:30px">Seguir</button>
                                            <button type="button" class="btn btn-outline-secondary button-edit " style="margin-left:58px;margin-top:30px" value="{{$prof_inta->id}}" id="privox">Privado</button>
                                        ...
                                        <div class="row">
                                                <div class="col-12">
                                                <h1 class="name">{{$prof_inta->name_prof}}</h1>
                                                    <p class="profile-desc">{{$prof_inta->bio}}</p>
                                                </div>
                                        </div>
