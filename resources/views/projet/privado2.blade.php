 ...
 <div id="rendero">
          ...
          <div class="row">
                   <form method="POST" id="stonix">
                          ...
                          <div class="group-control">
                                 ...
                                 <button type="button" class="btn btn-primary" style="border:none;border-radius:20px;width:100%;background-color:#79C2F2" onclick="add_comment_priv2()" id="odux" >Comentar</button>
                          </div>


                          <input type="hidden" value="{{$priv_receiv_user->id}}" name="hote_prof" >
   ...
   @section('scripts')
          ...
          <script>
                ...
                function add_comment_priv2(){
                  var formdata = new FormData($("#stonix")[0]);
                    $.ajaxSetup({ headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}});
                  $.ajax({
                     type:"post",
                     url : "{{url('projet/add_comment_priv_2')}}",
                     data : formdata,
                     processData:false,
                     contentType:false,
