   ...
   <br>
           <div class="card">
                          ...
                          <div>
                           ...
                           <label class="seguir" id="{{$perfil->id}}" style="margin-left:22px;margin-top:-10%;color:#08047A;background:linear-gradient(-100deg,rgb(1, 16, 22), #1bffff);font-family:aharoni">     <img src="{{asset('user/'.$perfil->photo)}}" class="imgx" style="margin-left:150px"></label>
                 ...
                 <form method="POST" id="ediat">
                    ...
                    <div class="row">
                          ...
                          <div class="col-6">
                               ...
                               <div class="group-control">
                                         ...
                                         <input type="text" class="form-control vidage" name="email" value="{{$perfil->email}}"  readonly=""/>
                          ...
                          <div class="col-6">
                               ...
                               <div class="group-control vidage">
                                         ...
                                         <input type="text" class="form-control vidage" name="name" value="{{$perfil->name}}" />
                          ...
                          <div class="col-6">
                               ...
                               <div class="group-control vidage">
                                         ...
                                         <input type="text" class="form-control vidage" name="curso" value="{{$perfil->curso}}" />
                   ...
                   <br>
                    ...
                    <div class="col-12">
                            ...
                            <div class="group-control">
                                    <button type="button" class="btn btn-primary " style="border:none;border-radius:20px;width:100%;background-color:#79C2F2" onclick="edit_user({{$perfil->id}})">Edit</button>
                            </div>
