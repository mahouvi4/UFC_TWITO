                ...
                <div><img src="{{asset('logou/log4.png')}}"></div>
                 ...
                 <form method="POST" id="stl">
                             ...
                             <div class="row">
                              ...
                              <div class="col-6">
                                  <div class="group-control">
                                      <input type="password" class="form-control il1 mt-2" name="password" placeholder="Your password">
                                  </div>
                              ...
                              <div class="group-control">
                                     <button type="button" class="btn btn-primary " style="border:none;border-radius:20px;width:100%;background-color:#79C2F2" onclick="login_prof()">Sign-In</button>
                              </div>
                             <strong><a href="{{url('prof/create')}}" style="color:#79C2F2;font-family:Broadway" >Don't have an account?</a></trong>
